INSERT INTO INVENTORY_ITEMS(INGREDIENT_NAME, AVAILABILITY, UNIT_COST) VALUES
  ('coffee', 10, 0.75),
  ...
  ('whipped_cream', 10,1.00);
   ...
   INSERT INTO DRINK_ITEMS (DRINK_NAME, COFFEE,DECAFE_COFEE,SUGAR,CREAM,STEAMED_MILK,FOAMED_MILK,ESPRESSO,COCOA,WHIPPED_CREAM) VALUES
